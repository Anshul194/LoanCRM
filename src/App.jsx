  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/masters/employee-incentive-structure"
          element={<EmployeeIncentiveStructure />}
        />
        <Route
          path="/masters/connectors-payout-structure"
          element={<ConnectorsPayoutStructure />}
        />
        ...
        <Route path="/masters/create-role" element={<CreateRole />} />
