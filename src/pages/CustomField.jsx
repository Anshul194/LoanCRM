    ...
    <div className="min-h-screen bg-[#f7f7f7] p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-md font-bold text-[#2F3287] tracking-wide ml-2">
            CUSTOM FIELDS
          </h1>
        </div>
              ...
              <tr className="bg-[#f7fafd] text-xs font-bold text-gray-700 uppercase">
                ...
                <th className="px-4 py-3 text-left whitespace-nowrap font-semibold">
                  <div className="flex items-center">
                    ...
                    <Filter
                      className="w-3 h-3 ml-1 text-gray-400 cursor-pointer hover:text-gray-600"
                      onClick={(e) => handleFilterClick("Field Type", e)}
                    />
                  </div>
                </th>
                <th className="px-4 py-3 text-left whitespace-nowrap font-semibold">
                  <div className="flex items-center">
                    ...
                    <Filter
                      className="w-3 h-3 ml-1 text-gray-400 cursor-pointer hover:text-gray-600"
                      onClick={(e) => handleFilterClick("Mandatory", e)}
                    />
                  </div>
                </th>
                <th className="px-4 py-3 text-left whitespace-nowrap font-semibold">
                  <div className="flex items-center">
                    ...
                    <Filter
                      className="w-3 h-3 ml-1 text-gray-400 cursor-pointer hover:text-gray-600"
                      onClick={(e) => handleFilterClick("Module", e)}
                    />
                  </div>
                </th>
                <th className="px-4 py-3 text-left whitespace-nowrap font-semibold">
                  <div className="flex items-center">
                    ...
                    <Filter
                      className="w-3 h-3 ml-1 text-gray-400 cursor-pointer hover:text-gray-600"
                      onClick={(e) => handleFilterClick("Form", e)}
                    />
                  </div>
                </th>
                <th className="px-4 py-3 text-left whitespace-nowrap font-semibold">
