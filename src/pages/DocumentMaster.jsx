  ...
  return (
    <div className="min-h-screen bg-[#fafafa] p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="bg-[#2F3287] text-white px-6 py-2 rounded-full text-xs font-medium">
          + Create New Document
        </button>
      </div>
      {/* Card/Table */}
            ...
            <tr className="bg-[#f7fafd] text-xs font-bold text-gray-700 uppercase">
              ...
              <th className="px-6 py-3 text-left whitespace-nowrap">
                <div className="flex items-center">
                  ...
                  <Filter
                    className="w-3 h-3 ml-1 text-gray-400 cursor-pointer hover:text-gray-600"
                    onClick={(e) => handleFilterClick("Type of Product", e)}
                  />
                </div>
              </th>
              <th className="px-6 py-3 text-left whitespace-nowrap">
                <div className="flex items-center">
                  ...
                  <Filter
                    className="w-3 h-3 ml-1 text-gray-400 cursor-pointer hover:text-gray-600"
                    onClick={(e) => handleFilterClick("Employment Type", e)}
                  />
                </div>
              </th>
              <th className="px-6 py-3 text-left whitespace-nowrap">
              ...
              <th className="px-6 py-3 text-left whitespace-nowrap">
                <div className="flex items-center">
                  ...
                  <Filter
                    className="w-3 h-3 ml-1 text-gray-400 cursor-pointer hover:text-gray-600"
                    onClick={(e) => handleFilterClick("Total Documents", e)}
                  />
                </div>
              </th>
              <th className="px-6 py-3 text-left whitespace-nowrap">
